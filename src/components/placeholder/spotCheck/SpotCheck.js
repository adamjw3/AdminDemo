...
class SpotCheck extends Component {
  render() {
    return (
    <Fragment>
      <Row>
      ...
      <Row gutter={16}>
        ...
        <Col span={8}>
          <Card title="Actions" style={{ marginBottom: "15px" }}>
            <Button type="primary" block style={{ marginBottom: "15px" }}>Reset Status</Button>
            <Button type="primary" block style={{ marginBottom: "15px" }}>Archive</Button>
          </Card>
        </Col>
      </Row>
    </Fragment>
